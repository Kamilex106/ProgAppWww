...
<body onload="startclock();zmienslajd()">
	...
	<div class="container">
		...
		<?php
/*Jeśli użytkownik wybrał zakładkę admin ma zostać wyświetlony
formularz logowania, a po jego wypełnieniu ma on zostać przetworzony- 
weryfikacja loginu i hasła, a następnie mają zostać wyświetlone przyciski do
wyświetlenia podstron lub dodania nowej podstrony jeśli zmienna SESSION["is_logged"] 
jest równa 1
*/
			if($_GET['idp'] == 'admin')
			{
...
/*
Jesli została otwarta podstrona "kontakt.php" ma zostać pokazany formularz kontaktowy 
i do przypomnienia hasła
*/
