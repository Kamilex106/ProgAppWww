...
public function DodajProdukty()
{
    ...
    <div class="dodawanie">
        ...
        <br>
            ...
            <br>
            Data utworzenia:
            <input type="date" name="data_utworzenia" required placeholder="Data utworzenia">
            <br>
            Data modyfikacji:
            <input type="date" name="data_modyfikacji" required placeholder="Data modyfikacji">
            <br>
            Data wygaśnięcia:
            <input type="date" name="data_wygasniecia" required placeholder="Data wygaśnięcia">
            <br>
